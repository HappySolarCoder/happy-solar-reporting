...
Simple mobile-friendly QA dashboard.
- Date filter (year/month)
- Total Sales KPI (uses /api/metrics/sales)

This keeps logic centralized in the metric endpoint.
"""
...
def render_html(year: int, month: int) -> str:
    # Uses same site origin; fetches JSON from our metric endpoint.
